...
return (
    <div className='w-full h-auto md:h-screen flex flex-col md:flex-row'>
        ...
        <div className='w-full md:w-1/2 h-full bg-[#1a1a1a] flex flex-col 
            p-8 sm:p-12 md:p-20 justify-center'
        >
            <div
                className='w-full max-w-none sm:max-w-[420px] md:max-w-[450px] mx-auto
                bg-[#1a1a1a] rounded-lg 
                p-6 sm:p-8 md:p-10 shadow-md border border-gray-500
                hover:shadow-[0_0_25px_5px_rgba(56,140,248,1)]
            ...
            >
                ...
                <div className='w-full flex flex-col mb-10 text-white'>
                    ...
                    <p className='text-base sm:text-lg mb-4'>Welcome! Please enter your information.</p>
                </div>
                ...
                <div className='w-full flex flex-col mb-4'>
                    <button
                        ...
                        my-2 font-semibold rounded-md py-3 sm:py-4
                        text-center flex items-center justify-center cursor-pointer
                        hover:bg-linear-to-r hover:from-cyan-600 hover:to-blue-600
                ...
                <div className='w-full flex items-center justify-center relative py-4'>
                    ...
                    <p className='text-base sm:text-lg absolute text-gray-500 bg-[#1a1a1a] px-2'>OR</p>
                </div>
                ...
                <button
                    ...
                    disabled={isAuthenticating}
                    className='w-full bg-gray-700 text-white font-semibold rounded-md shadow-md 
                    py-3 sm:py-4 border border-gray-600
                ...
                <div className='w-full flex items-center justify-center mt-10'>
                    <p className='text-sm font-normal text-gray-400'>
                        ...
                        <span className='font-semibold text-white cursor-pointer no-underline'>
